...
\begin{solution}\begin{proof}
  ...
  Since we have shown that $(14 | a) \Rightarrow (2 | a) \land (7 | a)$ and $(2 | a) \land (7 | a) \Rightarrow
...
\begin{solution}\begin{proof}
  ...
  $\mathcal{P}(A) - \mathcal{P}(B) \nsubseteq \mathcal{P}(A-B)$ and the statement is fase.
\end{proof}\end{solution}
...
\begin{solution}\begin{proof}
  ...
  But this is a contradiction since no natural can be a multiple of a natural greater than itself.
  So we have that $b | a \Rightarrow a = lcm(a, b)$.
