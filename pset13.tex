...
\begin{solution}\\
\includegraphics[width=\textwidth]{pset13_imgs/p6.jpg}
\end{solution}
...
\begin{solution}\\
\includegraphics[width=0.8\textwidth]{pset13_imgs/p7.jpg}
\end{solution}
...
\begin{solution}\\
$\lim_{x \to \infty} f(x) = L \iff \forall \varepsilon > 0, \exists N, \forall x, x > N \implies |f(x) - L| < \varepsilon$.

\includegraphics[width=\textwidth]{pset13_imgs/p8.jpg}
\end{solution}
...
\begin{solution}\\
\includegraphics[width=\textwidth]{pset13_imgs/p9.jpg}
\end{solution}
...
\begin{solution}\\
\includegraphics[width=\textwidth]{pset13_imgs/p10.jpg}
\end{solution}
